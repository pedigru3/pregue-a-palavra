...
List<ItemModel> listItems = [
  ItemModel(
    ...
    description: "Branca de neve é vítima da inveja de sua madrasta. Ela foge e se esconde na casa de sete pequenos trabalhadores na floresta. O que branca não sabe é que a terrível madrasta conhece seu paradeiro."
  ),
  ItemModel(
  ...
  ItemModel(
    ...
    description: "Obra incrivelmente atual e pertinente. Responde às perguntas que se fazem hoje (ordenação de pastoras; batalha espiritual, anjos, criação/evolução, dons do Espírito) além de tratar de todas as outras doutrinas clássicas do cristianismo."
  ),
];
